...
<br>
If the override is set to a tuple other than (0,0) the targeting prompt will be aborted and the script will attempt to direct the player straight to the new coordinates.<br><br>
